...
from starlette.exceptions import (
    HTTPException as StarletteHTTPException,  # Import Starlette's HTTPException
)
...
def add_exception_handlers(app: FastAPI) -> None:
    ...
    async def http_exception_handler(request: Request, exc: StarletteHTTPException):
        ...
        return create_response(
            ...
            else f"HTTP_ERROR_{exc.status_code}",
    ...
    async def custom_exception_handler(request: Request, exc: BaseCustomError):
        ...
        if hasattr(exc, "headers") and exc.headers:  # type: ignore
            for key, value in exc.headers.items():  # type: ignore
