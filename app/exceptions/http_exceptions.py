...
class BaseCustomError(Exception):
    ...
    def __init__(self, detail: str, status_code: int, error_code: str = None):  # type: ignore
        self.detail = detail
...
class NotFoundError(BaseCustomError):
    ...
    def __init__(self, detail: str = "Resource not found", error_code: str = "NOT_FOUND"):
        super().__init__(
            detail=detail, status_code=status.HTTP_404_NOT_FOUND, error_code=error_code
        )
...
class UnauthorizedError(BaseCustomError):
    ...
    def __init__(
        ...
        headers: dict = None,
        error_code: str = "UNAUTHORIZED",  # type: ignore
    ):
        self.headers = headers or {}
        super().__init__(
            detail=detail, status_code=status.HTTP_401_UNAUTHORIZED, error_code=error_code
        )
...
class ForbiddenError(BaseCustomError):
    ...
    def __init__(self, detail: str = "Forbidden", error_code: str = "FORBIDDEN"):
        super().__init__(
            detail=detail, status_code=status.HTTP_403_FORBIDDEN, error_code=error_code
        )
...
class BadRequestError(BaseCustomError):
    ...
    def __init__(self, detail: str = "Bad request", error_code: str = "BAD_REQUEST"):
        super().__init__(
            detail=detail, status_code=status.HTTP_400_BAD_REQUEST, error_code=error_code
        )
...
class ServerError(BaseCustomError):
    ...
    def __init__(self, detail: str = "Internal server error", error_code: str = "SERVER_ERROR"):
        super().__init__(
            detail=detail, status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, error_code=error_code
        )
