...
class BaseRepository[ModelType: Any]:
    """
    ...
    async def create(self, *, obj_in: dict[str, Any], commit_txn: bool | None = True) -> ModelType:
        """
        Create a new record.
    ...
    async def update(
        self, *, id: Any, obj_in: dict[str, Any], commit_txn: bool | None = True
    ) -> ModelType | None:
        """
    ...
    async def delete(self, *, id: Any, commit_txn: bool | None = True) -> ModelType | None:
        """
